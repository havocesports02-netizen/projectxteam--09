                    ...
                    <div class="element-wrapper">
                        ...
                        <div class="element-box">
                            ...
                            <form method="post" id="quickForm">
                                ...
                                <h4 class="form-header">Cadastro de Cliente</h4>

                                <div class="form-desc">Insira corretamente as informações necessárias

                                    abaixo para completar o cadastro.</a></div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Seller"  name='Vendedor' data-required="true" data-type="email" data-error-message="Vendedor is required" required>
                                ...
                                <div class="form-buttons-w">
                                  ...
                                  <button type="submit" class="btn btn-primary"  value="Register" name="register">Cadastrar</button></div>
